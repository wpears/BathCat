...
define([
'../api/js/dojo/dojo/request/handlers.js',
'../api/js/dojo/dojo/_base/declare.js',
'../api/js/dojo/dojo/_base/lang.js',
'../api/js/dojo/dojo/has.js',
'../api/js/dojo/dojo/_base/kernel.js',
'../api/js/dojo/dojo/_base/config.js',
'../api/js/dojo/dojo/_base/connect.js',
'../api/js/dojo/dojo/dom-style.js',
'../api/js/dojo/dojo/_base/array.js',
'../api/js/dojo/dojo/_base/json.js',
'../api/js/dojo/dojo/i18n.js',
'../api/js/dojo/dojo/_base/Color.js',
'../api/js/dojo/dojo/_base/sniff.js',
'../api/js/dojo/dojo/_base/window.js',
'../api/js/dojo/dojo/dom.js',
'../api/js/dojo/dojo/dom-construct.js',
'../api/js/dojo/dojo/dom-geometry.js',
'../api/js/dojo/dojo/sniff.js',
'../api/js/dojo/dojo/io-query.js',
'../api/js/dojo/dojo/topic.js',
'../api/js/dojo/dojo/on.js',
'../api/js/dojo/dojo/aspect.js',
'../api/js/dojo/dojo/dom-class.js',
'../api/js/dojo/dojo/Deferred.js',
'../api/js/dojo/dojox.js',
'../api/js/dojo/dojo/_base/fx.js',
'../api/js/dojo/dojo/mouse.js',
'../api/js/dojo/dojo/Evented.js',
'../api/js/dojo/dojo/domReady.js',
'../api/js/dojo/dojo/query.js',
'../api/js/dojo/dojo/ready.js',
'../api/js/dojo/dojo/dom-attr.js',
'../api/js/dojo/dojo/when.js',
'../api/js/dojo/dojo/keys.js',
'../api/js/dojo/dojo/text.js',
'../api/js/dojo/dojo/NodeList-dom.js',
'../api/js/dojo/dojo/dom-prop.js',
'../api/js/dojo/dojo/_base/Deferred.js',
'../api/js/dojo/dojo/_base/xhr.js',
'../api/js/dojo/dojo/request/watch.js',
'../api/js/dojo/dojo/request/util.js',
...
'../bathcat/modules/cleargraphics.js',
'../bathcat/modules/featureevents.js',
'../bathcat/modules/canvasidentify.js'],function(){
    return function(){}
})